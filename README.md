...
Note that RSEM files are not supplied here, the dds created by DESeq2 in initial lines is however and can be used to generate code in combination with the summary table .csv provided
